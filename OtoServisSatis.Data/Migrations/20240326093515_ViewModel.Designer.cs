...
{
    [DbContext(typeof(OtoDatabaseContext))]
    [Migration("20240326093515_ViewModel")]
            ...
            modelBuilder.Entity("OtoServisSatis.Entities.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EklenmeTarihi = new DateTime(2024, 3, 26, 12, 35, 14, 876, DateTimeKind.Local).AddTicks(4020),
                            KullaniciAdi = "admin",
                            RolId = 1,
                            Sifre = "12345",
                            Soyadi = "Kaya",
            ...
            modelBuilder.Entity("OtoServisSatis.Entities.Servis", b =>
                {
                    ...
                    b.Property<bool>("GarantiKapsamındaMı")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("YapılanIslemler")
                        .HasColumnType("nvarchar(max)");
